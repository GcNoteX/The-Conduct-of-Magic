...
#func prepare_character_data(location: int): 
	## TODO: Make it location based
	#spawn_location = location
	#var generic_names = GameConstants.GenericNames[location]
	#name = generic_names[randi() % len(generic_names)]
	#var face_sprites = GameConstants.CustomerSpritePool[location]
...
#func generate_commission(artifact: ArtifactData) -> CommissionData:
	...
	#new_commission.prepare_commission_data(self, artifact)
